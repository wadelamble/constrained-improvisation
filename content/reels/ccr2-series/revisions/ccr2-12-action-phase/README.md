...
Local review version. The published reel and its caption remain unchanged.
...
The existing caption's description of a calibration plot will need review if this version is accepted; that plot has been removed from this revision.
