A single instantaneous state, taken by itself, carries no information. Information appears only against a background of alternatives. An ensemble of initial conditions is therefore not merely a list of possibilities, but a probability density over exact instantaneous states. By weighting some states more heavily than others, it already encodes what is known about the actual condition of the system. If the ensemble has density \(\rho(x)\) on the space of states, then the realization of a particular state \(x\) carries surprisal
