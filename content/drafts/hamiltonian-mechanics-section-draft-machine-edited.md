...
The first thing Hamiltonian Mechanics makes us notice is that a physical law acts not only on one exact trajectory, but on a whole family of nearby possible states. Suppose we do not know the exact microstate of a system, only that it lies somewhere in a small connected region of possibility. This need not mean a formal statistical ensemble sampled from a distribution. Three balls tossed into the air, each with initial position and momentum known only to finite precision, already give the picture. One exact set of initial conditions would give one exact trajectory. Finite precision gives, instead, a small connected cloud of nearby possibilities. Liouville's theorem is about what happens to that cloud.

The cloud does not stay rigid. It may stretch, shear, bend, and become surprisingly intricate. But under exact conservative dynamics it does not simply compress away. Distinctions among nearby possibilities are not crushed out of existence. The law stirs possibilities without squeezing them into less possibility. This is the phenomenological core of Liouville's theorem.
